insert into post (author, title, content, created_datetime, modified_datetime) values ('rose', '테스트 게시글 제목 1', '테스트 게시글 내용 1', now(), now());
insert into post (author, title, content, created_datetime, modified_datetime) values ('rose', '테스트 게시글 제목 2', '테스트 게시글 내용 2', now(), now());
insert into post (author, title, content, created_datetime, modified_datetime) values ('rose', '테스트 게시글 제목 3', '테스트 게시글 내용 3', now(), now());
insert into post (author, title, content, created_datetime, modified_datetime) values ('rose', '테스트 게시글 제목 4', '테스트 게시글 내용 4', now(), now());
insert into post (author, title, content, created_datetime, modified_datetime) values ('rose', '테스트 게시글 제목 5', '테스트 게시글 내용 5', now(), now());
